            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                <div class="page-wrapper">
                    <div class="blog-title-area text-center">
                        ...
                        <span class="color-orange"><a title=""><?php echo $data['post']->category ?></a></span>
                    ...
                    <div class="blog-content">  
                        <div class="pp mb-3"><i><b>"<?php echo $data['post']->descript?>"</b></i></div>
                    ...
                    <div class="custombox authorbox clearfix">
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                <img src="<?php echo URL_ROOT; ?>/img/banner.jpg" alt="" class="img-fluid profile_pic"> 
                            </div><!-- end col -->
