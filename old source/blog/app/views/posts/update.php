    ...
    <div class="container mt-5">
        ...
        <form action="<?php echo URL_ROOT; ?>/posts/update/<?php echo $data['post']->post_id ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="category" name="category" value="<?php echo $data['post']->post_category ?>">
            </div>
            <div class="mb-3">
                <span class="invalidFeedback">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="descript" name="descript" value="<?php echo $data['post']->post_descript ?>">
            </div>
            <div class="mb-3">
                <span class="invalidFeedback">
