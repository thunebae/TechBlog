<DOCTYPE html>
    ...
    <div class="container">
        ...
        <div class="bg-white" style="text-align: center;">
                ...
                <img class="profile_pic" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg">
                <br>
                ...
                <form action="<?php echo URL_ROOT; ?>/users/update_profile" method="POST">
                    <div class="p-3 py-5" style="background-color:white;">
                        ...
                        <div class="row mt-2 align-items-center px-3">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control" name='fullname' id='fullname' placeholder="<?php echo $data['user']->user_fullname?>" value="">
                            </div>
                        </div> 
                        <!--Birthday-->
                        <div class="row mt-4 align-items-center px-3">
                            ...
                            <div class="col-8">
                            <input type="text" class="form-control" name='birthday' id='birthday' onblur="this.type='text'" onclick="(this.type='date')" value="" placeholder="<?php echo $data['user']->user_birthday?>">
                            </div>
                        </div> 
                        <!--Mobile number-->
                        <div class="row mt-4 align-items-center px-3">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control" name='phone' id='phone' placeholder="<?php echo $data['user']->user_phone?>" value="">
                            </div>
                        </div> 
                        <!--address-->
                        <div class="row mt-4 align-items-center px-3">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control" name='address' id='address' placeholder="<?php echo $data['user']->user_address?>" value="">
                            </div>
                        </div> 
                        <!--email-->
                        <div class="row mt-4 align-items-center px-3">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control" name='email' id='email' placeholder="<?php echo $data['user']->user_email?>" value="">
                            </div>
                        </div> 
                        <!--Profile Image-->
                        <div class="row mt-4 align-items-center px-3">
                            <div class="col-4">
                                <label for="file" class="col-form-label">Profile Image</label>
                            </div>
                            <div class="col-8">
                        ...
                        <div class="row mt-4 align-items-center px-3">
                                ...
                                <textarea class="form-control" id="descript" name="descript" rows="4" placeholder="<?php echo $data['user']->user_descript?>"></textarea>
                        </div> 
                        <!--button Update-->
