<DOCTYPE html>
    ...
    <div class="container">
        ...
        <div class="bg-white" style="text-align: center;">
                ...
                <img id="profile_pic" src="https://st3.depositphotos.com/15648834/17930/v/600/depositphotos_179308454-stock-illustration-unknown-person-silhouette-glasses-profile.jpg">
                <br>
                ...
                <form action="<?php echo URL_ROOT; ?>/users/update_profile" method="POST">
                    <div class="p-3 py-5" style="background-color:white;">
                        ...
                        <div class="row mt-4 align-items-center px-3">
                                ...
                                <textarea class="form-control" id="descript" name="descript" rows="4"></textarea>
                        </div> 
                        <!--button Update-->
