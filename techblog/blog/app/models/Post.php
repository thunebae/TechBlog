...
class Post
{
    ...
    {
        $this->db->query('SELECT post_id, post_title, category, descript, post_body, user_name FROM posts, users WHERE users.user_id = posts.user_id ORDER BY post_created DESC LIMIT :index_page, :posts_per_page');
